    ...
    children: [
      ...
      { path: 'condomini', component: () => import('@/views/CondominiView.vue'), meta: { title: 'Condomini', requiresTenant: true } },
      {
        ...
        children: [
          ...
          { path: 'fatture-elettroniche', component: () => import('@/views/FattureElettronicheView.vue'), meta: { title: 'Fatture Elettroniche' } },
      ...
      { path: 'fatture-elettroniche', component: () => import('@/views/FattureElettronicheView.vue'), meta: { title: 'Fatture Elettroniche', requiresTenant: true } },
      ...
      { path: 'impostazioni-pagamenti', component: () => import('@/views/PagamentiOnlineView.vue'), meta: { title: 'Pagamenti Online', requiresTenant: true } },

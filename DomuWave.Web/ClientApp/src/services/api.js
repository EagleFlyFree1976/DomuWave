...
export const fiscalYearApi = {
  ...
  getContoEconomico:        (id) => api.get(`/fiscal-years/${id}/conto-economico`),
  getFlussiCassa:           (id) => api.get(`/fiscal-years/${id}/flussi-cassa`),
  getSituazionePatrimoniale:(id) => api.get(`/fiscal-years/${id}/situazione-patrimoniale`),

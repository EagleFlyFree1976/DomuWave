              ...
              <div class="row ">
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <div class="d-flex align-items-center gap-2">
                      <Checkbox v-model="editEntity.updateTransactionDate" :binary="true" inputId="cb1" />
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <div class="d-flex align-items-center gap-2">
                      <Checkbox v-model="editEntity.updateStatus" :binary="true" inputId="cb1" />


                      <Select name="status"
                              :disabled="!editEntity.updateStatus"
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <div class="d-flex align-items-center gap-2">
                      <Checkbox v-model="editEntity.updateTransactionType" :binary="true" inputId="cb1" />

                      <Select name="transactionType"
                              v-model="editEntity.transactionType"
                              :options="transactionStore.filterLookups.transactionTypes"
                              optionLabel="description"
                              :disabled="!editEntity.updateTransactionType"
                              optionValue="id"
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <div class="d-flex align-items-center gap-2">
                      <Checkbox v-model="editEntity.updateAccountId" :binary="true" inputId="cb1" />

                      <Select name="account"
                              v-model="editEntity.account"
                              :options="accountlookups"
                              :disabled="!editEntity.updateAccountId"
                              optionLabel="code"
                ...
                <div class="col-md-6">
                  <div class="mb-3" v-if="isTrasfer">
                    ...
                    <div class="d-flex align-items-center gap-2">
                      <Checkbox v-model="editEntity.updateDestinationAccountId" :binary="true" inputId="cb1" />

                      <Select name="accountTo"
                              v-model="editEntity.destinationAccount"
                              :options="accountlookups"
                              optionLabel="code"
                              :disabled="!editEntity.updateDestinationAccountId"  
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <div class="d-flex align-items-center gap-2">
                      <Checkbox v-model="editEntity.updatePaymentMethodId" :binary="true" inputId="cb1" />
                      ...
                      <Select name="paymentmethod"
                              ...
                              optionLabel="description"
                              :disabled="!editEntity.updatePaymentMethodId"
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <div class="d-flex align-items-center gap-2">
                      <Checkbox v-model="editEntity.updateAmount" :binary="true" inputId="cb1" />


                      <InputNumber v-model="editEntity.amount"
                                   :min="0"
                                   :disabled="!editEntity.updateAmount"
                                   :step="0.01"
                                   :useGrouping="true"
                                   :minFractionDigits="2"
                                   :maxFractionDigits="2"
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <div class="d-flex align-items-center gap-2">
                      <Checkbox v-model="editEntity.updateBeneficiary" :binary="true" inputId="cb1" />
                      <AutoComplete name="beneficiary" optionLabel="description" v-model="editEntity.beneficiary"
                                    ...
                                    minLength="2"
                                    :disabled="!editEntity.updateBeneficiary"
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <div class="d-flex align-items-center gap-2">
                      <Checkbox v-model="editEntity.updateCategoryId" :binary="true" inputId="cb1" />
                      <AutoComplete name="category" optionLabel="description" v-model="editEntity.category"
                                    ...
                                    minLength="2"
                                      :disabled="!editEntity.updateCategoryId"
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <div class="d-flex align-items-center gap-2">
                      <Checkbox v-model="editEntity.updateCurrencyId" :binary="true" inputId="cb1" />

                      <AutoComplete name="currency" optionLabel="description" v-model="editEntity.currency"
                                    :suggestions="currencies" fluid
                                    minLength="2"
                                    :disabled="!editEntity.updateCurrencyId || !enableCurrency"
 ...
 $form.currency.error?.message
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <div class="d-flex align-items-center gap-2">
                      <InputText name="rate" type="number" :disabled="!editEntity.updateCurrencyId || !enableRate" placeholder="Specifica il tasso" fluid v-model="editEntity.rate" class="w-100" />
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="mb-3">
                    ...
                    <div class="d-flex align-items-center gap-2">
                      <Checkbox v-model="editEntity.updateDescription" :binary="true" inputId="cb1" />
                      <Textarea v-model="editEntity.description" rows="5" cols="30" class="w-100"   :disabled="!editEntity.updateDescription" />
...
<script setup>
  ...
  const resolver = ({ values }) => {
    ...
    if (editEntity.updateTransactionType) {
    ...
    if (editEntity.updateTransactionDate) {
  ...
  const onFormSubmit = async ({ valid }) => {
    ...
    if (valid) {
      ...
      try {
        ...
        await transactionStore.saveMassive(editEntity.value);
        success = true;

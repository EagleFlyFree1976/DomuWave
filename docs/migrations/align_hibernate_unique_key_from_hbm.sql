...
BEGIN TRY
    ...
    VALUES
        ...
        (N'Assembly',                         N'Assembly',                         N'Id',          10),
        (N'AssemblyAgendaItem',               N'AssemblyAgendaItem',               N'Id',          10),
        (N'AssemblyAttendance',               N'AssemblyAttendance',               N'Id',          10),
        (N'BillingGroup',                     N'BillingGroup',                     N'Id',          10),
        (N'Budget',                           N'Budget',                           N'Id',          10),
        (N'BudgetItem',                       N'BudgetItem',                       N'Id',          10),
        (N'Building',                         N'Building',                         N'Id',          10),
        ...
        (N'CommunicationNotification',        N'CommunicationNotification',        N'Id',          10),
        ...
        (N'ConsumptionCharge',                N'ConsumptionCharge',                N'Id',          10),
        (N'ConsumptionChargeItem',            N'ConsumptionChargeItem',            N'Id',          10),
        (N'ConsumptionReading',               N'ConsumptionReading',               N'Id',          10),
        (N'ConsumptionType',                  N'ConsumptionType',                  N'Id',          10),

-- ============================================================
-- Migration: VZCondominio -> DomuWave (Stage 0 Foundation SP)
-- Contiene: dbo.sp_migration_stage0_foundation
-- ============================================================
...
CREATE OR ALTER PROCEDURE dbo.sp_migration_stage0_foundation
AS
BEGIN
-- ============================================================
...
-- 3) Abilitare controlli qualitÃ  dati prima del caricamento finale
--
-- NOTE:
-- - Script NON modifica tabelle di dominio esistenti.
-- - Script idempotente: puÃ² essere rilanciato senza effetti collaterali.
...
-- ------------------------------------------------------------
-- 4) Query di controllo qualitÃ  (eseguire dopo load staging)
-- ------------------------------------------------------------
-- 4.1 UnitÃ  senza condominio/edificio coerente
...
-- [ ] Eseguire query di controllo qualitÃ  e risolvere anomalie

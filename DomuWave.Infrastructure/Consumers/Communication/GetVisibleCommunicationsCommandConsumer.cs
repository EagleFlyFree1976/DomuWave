...
public class GetVisibleCommunicationsCommandConsumer : InMemoryConsumerBase<GetVisibleCommunicationsCommand, IList<CommunicationReadDto>>
{
        ...
        CancellationToken               cancellationToken)
    {
        ...
        var list = await session.Query<Communication>()
            .Where(c => c.Condominium.Id == command.CondominiumId && c.IsVisible && !c.IsDeleted)

...
public class GetUnreadCommunicationsCommandConsumer : InMemoryConsumerBase<GetUnreadCommunicationsCommand, IList<Communication>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return await _communicationService
            .GetUnreadByUserAsync(command.CondominiumId, command.UserId, currentUser, cancellationToken)
            .ConfigureAwait(false);
    }
}

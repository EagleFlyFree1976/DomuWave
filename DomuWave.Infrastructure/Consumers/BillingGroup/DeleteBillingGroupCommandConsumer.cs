...
public class DeleteBillingGroupCommandConsumer
    : InMemoryConsumerBase<DeleteBillingGroupCommand, bool>
{
    private readonly IUserService _userService;

    public DeleteBillingGroupCommandConsumer(
    ...
    protected override async Task<bool> Consume(
        DeleteBillingGroupCommand command,
        ...
        CancellationToken          cancellationToken)
    {
        ...
        // Detach units before soft-delete

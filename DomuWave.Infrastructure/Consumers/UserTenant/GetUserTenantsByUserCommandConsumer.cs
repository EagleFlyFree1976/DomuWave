...
public class GetUserTenantsByUserCommandConsumer : InMemoryConsumerBase<GetUserTenantsByUserCommand, IList<UserTenant>>
{
    private readonly IUserTenantService _userTenantService;
    private readonly IUserService _userService;

    public GetUserTenantsByUserCommandConsumer(
    ...
    protected override async Task<IList<UserTenant>> Consume(
        GetUserTenantsByUserCommand command,
